...
```bash
git remote add encore encore://serasi-parket-website-b45i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/serasi-parket-website-b45i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/serasi-parket-website-b45i/settings/integrations/github)
